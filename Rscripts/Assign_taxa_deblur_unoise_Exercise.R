...
setwd("/home/jacob/projects/DenoiseCompare_Out/Exercise_med/med/deblurP/final/")
...
setwd("/home/jacob/projects/DenoiseCompare_Out/Exercise_med/med/Unoise/")
unoisetable <- read.table("otutab.tsv",                           
                          header=TRUE, 
                          sep="\t", 
                          stringsAsFactors = F, 
                          comment.char="",
