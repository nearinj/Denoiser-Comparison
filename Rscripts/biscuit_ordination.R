...
setwd("/home/jacob/projects/DenoiseCompare_Out/biscuit/med/COMBINED/")
...
bray_curtis_dm <- read.table("Tax_Sum/Bray_Curtis/bray_curtis_Combined_biscuit_taxa_L6.txt",
                             sep="\t", 
                             header=T, 
                             stringsAsFactors = FALSE,
                             row.names=1)
