...
library(ggplot2)
setwd("/home/jacob/projects/DenoiseCompare_Out/biscuit/med/COMBINED/Tax_Sum/Bray_Curtis/")

par=(mfrow=c(2,2))
# Read in bray-curtis distance matrix (at genus level) of samples from all 3 pipelines
DM <- read.table("bray_curtis_Combined_biscuit_taxa_L6.txt", sep="\t", header=TRUE, row.names=1)
