...
bray_curtis_dm <- read.table("Tax_Sum/Bray_Curtis/bray_curtis_Combined_Exercise_taxa_L6.txt",
                             sep="\t", 
                             header=T, 
                             stringsAsFactors = FALSE,
                             row.names=1)
...
bray_curtis_NMDS_df <- data.frame(NMDS1=bray_curtis_NMDS$points[,1], 
                                 ...
                                 Pipeline=as.factor(meta[rownames(bray_curtis_NMDS$points), "Pipeline"]))
