...
./get_blast_results.py -f ../../../DenoiseCompare_Out/HMPV4-V5/med/OpenRef_OTU/final/dna-sequences.fasta -b ../../../DenoiseCompare_Out/Blast_Results/HMP//HMP/OpenMed.out -o BlastResults.tsv
./get_blast_results.py -f ../../../DenoiseCompare_Out/Zymock/med/OpenRef_OTU/final/dna-sequences.fasta -b ../../../DenoiseCompare_Out/Blast_Results/Zymock/OpenMed.out -o BlastResults.tsv
./get_blast_results.py -f ../../../DenoiseCompare_Out/Its-Mock9/med/OpenRef_OTU/final/dna-sequences.fasta -b ../../../DenoiseCompare_Out/Blast_Results/Mock-9/OpenMed.out -o BlastResults.tsv
./get_blast_results.py -f ../../../DenoiseCompare_Out/Mock-12/med/OpenRef_OTU/final/dna-sequences.fasta -b ../../../DenoiseCompare_Out/Blast_Results/Mock-12/OpenMed.out -o BlastResults.tsv
